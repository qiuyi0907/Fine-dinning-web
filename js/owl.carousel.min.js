  ...
  (function (a, b, c) {
    var d = {
      ...
      loadContent: function () {
        ...
        var c,
          d = this;
        "function" == typeof d.options.beforeInit &&
          d.options.beforeInit.apply(this, [d.$elem]),
          "string" == typeof d.options.jsonPath
            ? ((c = d.options.jsonPath), a.getJSON(c, b))
            : d.logIn();
      },
      logIn: function () {
      ...
      response: function () {
        ...
        (d = a(b).width()),
          (e.resizer = function () {
            a(b).width() !== d &&
              (!1 !== e.options.autoPlay && b.clearInterval(e.autoPlayInterval),
              b.clearTimeout(c),
              (c = b.setTimeout(function () {
                (d = a(b).width()), e.updateVars();
              }, e.options.responsiveRefreshRate)));
          }),
          a(b).resize(e.resizer);
      },
      ...
      loops: function () {
        var b,
          ...
          e = 0;
        for (
          this.positionsInArray = [0], this.pagesInArray = [], b = 0;
          b < this.itemsAmount;
          b += 1
        )
          (e += this.itemWidth),
            ...
            !0 === this.options.scrollPerPage &&
              ((c = a(this.$owlItems[b])),
              (c = c.data("owl-roundPages")) !== d &&
                ((this.pagesInArray[d] = this.positionsInArray[b]), (d = c)));
      },
      ...
      lazyPreload: function (a, c) {
        function d() {
          a.data("owl-loaded", "loaded").removeClass("loading"),
            ...
            "function" == typeof g.options.afterLazyLoad &&
              g.options.afterLazyLoad.apply(this, [g.$elem]);
        }
        function e() {
          (h += 1),
            g.completeImg(c.get(0)) || !0 === f
              ? d()
              : 100 >= h
              ? b.setTimeout(e, 100)
              : d();
      ...
      autoHeight: function () {
        function c() {
          ...
          f.wrapperOuter.css("height", c + "px"),
            f.wrapperOuter.hasClass("autoHeight") ||
              b.setTimeout(function () {
        ...
        function d() {
          (e += 1),
            f.completeImg(g.get(0))
              ? c()
              : 100 >= e
              ? b.setTimeout(d, 100)
              : f.wrapperOuter.css("height", "");
        }
        var e,
          f = this,
